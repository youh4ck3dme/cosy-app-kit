...
| --- | --- | --- |
| **v0.5.0** Builder Runtime Foundation | Wire kernel into a durable runtime surface (host session, safer boundaries) | Planned — decision locked in [ADR-0005](./adr/ADR-0005-builder-runtime-foundation.md); implementation not started |
